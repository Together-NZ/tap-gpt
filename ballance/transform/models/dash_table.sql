...
UNION ALL
{{ dash_table_general_process.meta(source_name='facebook_transformed__brand', table_name='facebook__brand') }}
UNION ALL
{{ dash_table_general_process.meta(source_name='facebook_transformed__simp', table_name='facebook__simp') }}
UNION ALL
