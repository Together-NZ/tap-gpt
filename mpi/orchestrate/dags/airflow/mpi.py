...
COMPARISON_SECRET = "airflow-variables-meltano_mpi_main"
...
# ---------------------------------------------------------------------------
# DAG 1: Social / Display / Programmatic (schedule: 03:00 NZST daily)
# Flow: CM360 >> [DV360, TTD]; [facebook, dv360, ttd, cm360] >> dash >> dash_union
# ---------------------------------------------------------------------------
with models.DAG(
    ...
    # CM360 before DV360/TTD (Kiwibank/Barfoot); social-only closes with dash → dash_union (no search)
