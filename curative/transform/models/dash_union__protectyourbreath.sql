...
WITH final_result AS (
    {{ dash_table_general_process.dash_union_non_search(
        source_name='dash_union__protectyourbreath',
        table_name='dash_table__protectyourbreath',
        sub_brands=env_var('SUB_BRANDS', 'null')
    ) }}
    UNION ALL
    {{ dash_table_general_process.dash_union_search(
        source_name='dash_table_search__protectyourbreath',
        table_name='dash_table_search__protectyourbreath',
        sub_brands=env_var('SUB_BRANDS', 'null')
    ) }}
)
SELECT
