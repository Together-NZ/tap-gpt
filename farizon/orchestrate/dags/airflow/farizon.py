...
with models.DAG(
    ...
    kube_ga4_final = KubernetesPodOperator(
        name="farizon-ga4-final-to-bigquery",
        task_id="farizon-ga4_final_to_bigquery",
        namespace="composer-user-workloads",
        image=IMAGE,
    ...
    for goal in ["goal", "session", "keyword"]:
        kube_ga4_t = KubernetesPodOperator(
            name=f"farizon-ga4-{goal}-to-bigquery",
            task_id=f"farizon-ga4_{goal}_to_bigquery",
            namespace="composer-user-workloads",
            image=IMAGE,
            arguments=[
                "--environment=prod",
