...
**Providers** -- Plugins that connect Terraform to cloud platforms (GCP, AWS, Azure, etc.). In this project:
...
When you run `terraform apply`, it creates all those datasets in the `kiwibank-main` GCP project with the exact permissions specified.
