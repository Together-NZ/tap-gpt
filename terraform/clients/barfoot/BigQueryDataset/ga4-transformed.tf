resource "google_bigquery_dataset" "ga4_transformed" {
  access {
...
# terraform import google_bigquery_dataset.ga4_transformed projects/barfoot-and-thompson-main/datasets/ga4_transformed
