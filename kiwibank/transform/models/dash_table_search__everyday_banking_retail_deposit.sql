...
CASE WHEN 'INTENT' IN (select distinct funnel from `kiwibank-main.dash_table__everyday_banking_retail_deposit.dash_table__everyday_banking_retail_deposit`) then 'INTENT'
