...
with dash_table AS (
SELECT * FROM `kiwibank-main.google_ads_search_transformed__everyday_banking_retail_deposit.google_ads_search__everyday_banking_retail_deposit1`
UNION ALL
SELECT * FROM `kiwibank-main.google_ads_search_transformed__everyday_banking_retail_deposit.google_ads_search__everyday_banking_retail_deposit2`
)
SELECT *,
CASE WHEN 
...
CASE WHEN 'CHOOSE' IN (select distinct funnel from `kiwibank-main.dash_table__everyday_banking_retail_deposit.dash_table__everyday_banking_retail_deposit`) then 'CHOOSE'
