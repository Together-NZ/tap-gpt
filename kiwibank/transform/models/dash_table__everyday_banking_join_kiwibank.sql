...
UNION ALL
{{dash_table_general_process.cm360(source_name='cm360_transformed', table_name='cm360_direct_buy_no_dv360')}} WHERE campaign_name LIKE '%000001%'
UNION ALL
{{dash_table_general_process.ttd(source_name='ttd_transformed', table_name='ttd')}} WHERE campaign_name LIKE '%000001%'
...
platform FROM `kiwibank-main.gpt_transformed.gpt` WHERE target_url LIKE '%000001%' 
),
with_channel AS (
