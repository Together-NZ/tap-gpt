...
CASE WHEN 'INTENT' IN (select distinct funnel from `kiwibank-main.dash_table__everyday_banking_join_kiwibank.dash_table__everyday_banking_join_kiwibank`) then 'INTENT'
