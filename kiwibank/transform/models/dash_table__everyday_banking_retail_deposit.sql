...
UNION ALL
{{dash_table_general_process.cm360(source_name='cm360_transformed', table_name='cm360_direct_buy_no_dv360')}} WHERE campaign_name LIKE '%00005%'
UNION ALL
...
platform FROM `kiwibank-main.gpt_transformed.gpt` WHERE target_url LIKE '%00005%' 
),
with_channel AS (
