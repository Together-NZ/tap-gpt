...
WITH final_result AS (
  {{ dash_table_general_process.dash_union_non_search(source_name='dash_union__retirement_commission', table_name='dash_table__retirement_commission',sub_brands=env_var('SUB_BRANDS', 'null')) }}
)
SELECT
